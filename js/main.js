...
<header class="game-header">
  ...
  <ul class="game-list">
    ...
    return `<li><img class="close visually-hidden" src="img/close.png" width="110" height="275" alt="Закрытая карта"><img class="open" src="${i}" width="110" height="275" alt="Карта"></li>`;
  }).join(``)}
  </ul>
  </section>`;
    }
  ...
  const calculateScore = (correctanswer, card) => {
    let score;
    if (score == undefined) {
      score = 0;
    }
